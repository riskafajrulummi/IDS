...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 20, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:23889',
            extent: [410636.476400, 9112386.000500, 448403.311800, 9141229.889100],
            units: 'm'})
    })
});
...
map.getView().fit([410636.476400, 9112386.000500, 448403.311800, 9141229.889100], map.getSize());
